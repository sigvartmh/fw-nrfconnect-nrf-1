...
If you do not want to host it yourself, you can upload it to an public S3 bucket on AWS.
See `Hosting your image on AWS S3`_ for instructions.
...
1. Go to `console.aws.amazon.com/s3`_ and sign in.
   If you already have an AWS account, you can use the same credentials.
...
When specifying the image file, use the ``<bucket-name>.s3.<region>.amazonaws.com`` part of the URL for the download host name.
