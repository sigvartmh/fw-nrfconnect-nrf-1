 ...
 *
 * @param buf[in] A buffer of bytes which are the start of an binary firmware image.
 ...
 *
 * @param buf[in] A buffer of bytes which contains part of an binary firmware image.
 * @param len[in] The length of the provided buffer.
 *
 * @return Positive identifier for a supported image type or a negative error
 *	   code identicating reason of failure.
