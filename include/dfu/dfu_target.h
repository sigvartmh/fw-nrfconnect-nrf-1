 ...
 *
 * @param buf[in] A buffer of bytes which are the start of an binary firmware
 *		  image.
 * @param len[in] The length of the provided buffer.
 *
 ...
 *
 * @param buf[in] A buffer of bytes which contains part of an binary firmware
 *		  image.
 * @param len[in] The length of the provided buffer.
 *
 * @return Positive identifier for a supported image type or a negative error
 ...
 *	  target.
 *
 * @param successful[in] Indicate whether the process completed successfully or
 *			 was aborted.
 *
