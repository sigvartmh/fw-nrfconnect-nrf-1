...
.. |note| replace:: To upgrade the firmware on the network core, perform the procedure listed below replacing :file:`app_update.bin` with :file:`net_core_app_update.bin`.
